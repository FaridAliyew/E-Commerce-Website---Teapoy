        ...
        <Container fluid className='footer bg-black p-5 '>
            <Row className='footer-row d-flex justify-content-between'>
                <Col sm={12} xl={2} className='text-sm-center text-xl-start ms-md-5'>
                    ...
                    <p className='text-white text-sm-center text-xl-start'>Donec elementum aliquet dui, ut feugiat est vulputate quis. Etiam egestas nulla nec odio posuere, ut porta tortor pretiumt.</p>
                    <div className='mt-4'>
